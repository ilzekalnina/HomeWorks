...
func calculateResult(firstNumber numberOne: Int, andSecondNumber numberTwo: Int, withCalculationType calculateResult: CalculationType ) -> Int {
    ...
    print("Result:  \(calculateResult.rawValue) \(numberOne) and \(numberTwo) = \(result)")
    return result
}
...
struct Car {
    ...
    var horsePower: Int
    func getSpecs() {
        print("Model: \(name), year: \(productionYear) and horse power \(horsePower)")
    }
...
let audiQ7 = Car(name: "audiQ7", productionYear: 2019, horsePower: 286)
var audiTT = audiQ7
audiTT.name = "audiTT"
